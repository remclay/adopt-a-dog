...
pointer = Breed.create(name: "Pointer")
...
Dog.create({name: "Rosie", age: "2", user_id: "#{john.id}", breed_ids: ["#{pointer.id}"], description: "Rosie loves eating ice cream and going for walks. She is a playful but well behaved dog, who is always happy to see you."})
