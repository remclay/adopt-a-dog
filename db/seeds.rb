...
kate = User.create({username: "kate_dog_lover", email: "kate_dog_lover@gmail.com", password: "adoptdontshop"})
...
Dog.create({name: "Fido", age: "2.5", user_id: "#{peter.id}", description: "Comfortable around other dogs and most cats. Fido is still being trained, but can already sit, fetch and stay! Please email me for pictures or to arrange a time to meet this charming boy."})
